...
class AMCViewController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        moviesTable.registerNib(UINib(nibName: "FriendTableViewCell", bundle: nil), forCellReuseIdentifier: "FriendTableViewCell")
        loadMovies()
    ...
    func loadMovies() {
        ...
        Async.background{
            RestApiManager.sharedInstance.getActorMovies(self.actorId!,onCompletion: { json in
                let results = json
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        _ = self.moviesTable.cellForRowAtIndexPath(indexPath)
